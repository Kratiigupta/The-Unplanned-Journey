  ...
  useEffect(() => {
    ...
    class App {
      constructor(container, options = {}) {
        ...
        this.renderer.setPixelRatio(Math.min(window.devicePixelRatio, 1.5)); // Capped pixel ratio for performance
      ...
      initPasses() {
        ...
        this.bloomPass.renderToScreen = true; // Bloom is the final pass now
      ...
      loadAssets() {
        // Assets removed because SMAA is disabled for performance
